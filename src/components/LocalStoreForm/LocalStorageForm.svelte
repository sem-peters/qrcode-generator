<script lang="ts">
    ...
    import applicationData, {getDefaultQr, saveToLocalStorage,} from "@src/stores/ApplicationDataStore";
    ...
    const switchToCode = (e: Event) => {
        $applicationData.currentlySelectedId = (e.target as HTMLOptionElement).value as string;
        saveToLocalStorage();
    };
